...
Hi!, I’m a Research Scientist at [Northeastern University](https://www.khoury.northeastern.edu/) working in [Gyori Lab for Computational Biomedicine](https://gyorilab.github.io/) as an NLP specialist developing solutions for retrieval, extraction and grounding in the biomedical domain.

Prior to that, I was at [The University of Arizona](https://www.cs.arizona.edu/), where I collaborate with the [CLU Lab](https://clulab.org) and [Data Science Institute](https://web.archive.org/web/20251217205311/https://datascience.arizona.edu/). My expertise lies in leveraging large language models to transform unstructured text into structured insights. I’m passionate about creating smart search tools that empower researchers and scholars to uncover valuable insights from complex data.
